...
def argue():
    ...
    parser.add_argument(
        ...
        "--sidecar_file",
        default="sidecar.txt",
        help="SCTE35 Sidecar file. each line contains  PTS, Cue (default sidecar.txt)",
    )
    ...
    parser.add_argument(
        ...
        default=False,
        const=True,
        help="Flag for replay (looping) ( enables --delete )",
    )
    ...
    parser.add_argument(
        ...
        default=False,
        const=True,
        help="Flag to enable Shulga iframe detection mode (mpeg2)",
    )
    parser.add_argument(
        "-v",
        "--version",
    ...
    parser.add_argument(
        ...
        default=False,
        const=True,
        help="Flag to add Program Date Time tags to index.m3u8",
    )
